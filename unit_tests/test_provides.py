...
class TestRegisteredHooks(test_utils.TestRegisteredHooks):
    ...
    def test_hooks(self):
        ...
        hook_clear = {
            'when_any': {
                'broken': ('endpoint.{endpoint_name}.available',
                           'endpoint.{endpoint_name}.connected'),
                'departed': ('endpoint.{endpoint_name}.available',
                             'endpoint.{endpoint_name}.connected'),
            },
        }
...
class TestPlacementProvides(test_utils.PatchHelper):
    ...
    def test_changed(self):
        ...
        self.clear_flag.assert_called_once_with('endpoint.some-endpoint.changed')
